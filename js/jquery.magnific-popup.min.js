            ...
            proto: {
                ...
                resizeImage: function () {
                    ...
                    if (a && a.img && b.st.image.verticalFit) {
                        ...
                        a
                            .img
                           .css("max-height", b.wH - c) // 사진을 화면 높이에 맞추기->원래 있던 구문
                ...
                initGallery: function () {
                    ...
                    c && c.enabled
                        ? (
                            f += " mfp-gallery",
                            w(m + e, function () {
                                var img_small = 1; //★★★ 클릭전 사진 상태 기억
                                c.navigateByImgClick && b
                                    .wrap
                                    .on("click" + e, ".mfp-img", function () {
                                        
                                        //★★★★ 1 상태일때는 확대 시키고 아니면 축소 시켜라
                                        if(img_small == 1){
                                            $(this).css({'cursor': 'zoom-out',"max-height": '100%'})
                                            img_small = 2
                                        }else{
                                            $(this).css({'cursor': 'zoom-in',"max-height": b.wH})
                                            img_small = 1
                                        } 
                                ...
                                if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
                                    var d = c.arrowMarkup,
                                        e = b.arrowLeft = a(d.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, "left")).addClass(
                                            s
                                        ).css({'position':'fixed'}), //★★★ 버튼 고정되도록css 추가
                                        f = b.arrowRight = a(
                                            d.replace(/%title%/gi, c.tNext).replace(/%dir%/gi, "right")
                                        ).addClass(s).css({'position':'fixed'}); //★★★ 버튼 고정되도록css 추가
                                    e.click(function () {
                                        b.prev()
                                    }),
                                    f.click(function () {
